...
namespace HostBox.Logging
{
    public partial class NLogLogger : AbstractLogger
    {
        ...
        /// <inheritdoc />
        public override bool IsTraceEnabled => this.logger.IsTraceEnabled;

        /// <inheritdoc />
        public override bool IsDebugEnabled => this.logger.IsDebugEnabled;

        /// <inheritdoc />
        public override bool IsErrorEnabled => this.logger.IsErrorEnabled;

        /// <inheritdoc />
        public override bool IsFatalEnabled => this.logger.IsFatalEnabled;

        /// <inheritdoc />
        public override bool IsInfoEnabled => this.logger.IsInfoEnabled;

        /// <inheritdoc />
        public override bool IsWarnEnabled => this.logger.IsWarnEnabled;
